...
// get employee by id
	...
	@GetMapping("/{id}")
	public ResponseEntity<EmployeeResponse> getEmployeeById(@PathVariable("id") @Min(1) Long id) throws EmployeeNotFoundException {
...
//	filter employee by name
	...
	public ResponseEntity<List<EmployeeResponse>> getEmployeeByName(@PathVariable("name") String employeeName)throws EmployeeNotFoundException{
...
//pagination and sorting	
	...
	public ResponseEntity<List<EmployeeResponse>> getAllEmployee(@RequestParam(defaultValue = "0") int pageNo,
			@RequestParam(defaultValue = "10") int pageSize, @RequestParam(defaultValue = "id") String sortBy,@RequestParam(defaultValue = "asc") String sortDir) {
